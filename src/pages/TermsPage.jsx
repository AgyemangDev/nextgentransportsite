    ...
    <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm mb-8">
        ...
        <p className="text-gray-700 mb-4">
          Welcome to TransportGo. These terms and conditions outline the rules
        ...
        <p className="text-gray-700 mb-4">
          ...
          TransportGo's services if you do not accept all of the terms and
        ...
        <p className="text-gray-700">
          ...
          Company", "Ourselves", "We", "Our" and "Us", refers to TransportGo.
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm mb-8">
        ...
        <p className="text-gray-700 mb-4">
          ...
          email or SMS from TransportGo. The booking confirmation will include
        ...
        <p className="text-gray-700 mb-4">
          TransportGo reserves the right to change fares without prior notice.
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm mb-8">
        ...
        <h3 className="font-semibold text-lg mb-2">
          3.2 Cancellation by TransportGo
        </h3>
        <p className="text-gray-700 mb-4">
          In the event that TransportGo cancels a service, customers will be
          offered either:
        </p>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm mb-8">
        ...
        <p className="text-gray-700 mb-4">
          The following items are prohibited from being carried on TransportGo
          buses:
        </p>
        ...
        <p className="text-gray-700">
          TransportGo's liability for loss or damage to luggage is limited to
          ...
          TransportGo is not liable for the loss of or damage to hand luggage
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm">
        ...
        <p className="text-gray-700 mb-4">
          ...
          to comply with the instructions of TransportGo staff. TransportGo
        ...
        <p className="text-gray-700 mb-4">
          TransportGo reserves the right to modify these terms and conditions at
          any time. Changes will be effective immediately upon posting on the
          website. Continued use of TransportGo's services after any such
